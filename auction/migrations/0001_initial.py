    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('artist', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='artist_painting', to='user.user', verbose_name='원작자')),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='auction.category', verbose_name='카테고리')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='owner_painting', to='user.user', verbose_name='소유자')),
            ],
            options={
                'db_table': 'paintings',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bidder', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='user.user')),
